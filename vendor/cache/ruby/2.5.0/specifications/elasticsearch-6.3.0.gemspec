# -*- encoding: utf-8 -*-
# stub: elasticsearch 6.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<elasticsearch-transport>.freeze, ["= 6.3.0"])
      s.add_runtime_dependency(%q<elasticsearch-api>.freeze, ["= 6.3.0"])
      ...
      s.add_dependency(%q<elasticsearch-transport>.freeze, ["= 6.3.0"])
      s.add_dependency(%q<elasticsearch-api>.freeze, ["= 6.3.0"])
